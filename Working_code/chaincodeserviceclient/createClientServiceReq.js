...
module.exports = {
    createRequestDetails: async function(requestId,issue_type,product,subject,description) {
...
main("10000", "Req by prabhat", "BG","Subjecton Guarantee","Request for Guarantee product-approve suresh" ).then(() => {
