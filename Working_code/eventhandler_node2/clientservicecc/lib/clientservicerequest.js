...
class ClientServiceRequest extends State {
    ...
    static createInstance(requestId,issue_type,product,subject,description) {
        return new ClientServiceRequest({requestId,issue_type,product,subject,description});
    }
