...
app.post('/createChat',async(req,res) => {
  ...
  try{
    ...
    const chatrequest = await chatServicerequest.chatRequestDetails(`${req.body.room_id}`,`${req.body.room_name}`,`${req.body.userId}`,`${req.body.userName}`,`${req.body.message}`,`${req.body.messageid}`,`${req.body.description}`);
