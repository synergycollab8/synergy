...
async function getContactRequest(req,response) {
    ...
    return new Promise(function (resolve, reject) {
	   ...
	   return resolve("{\"reason\":\"not found\"}");
       });
   });
};
...
async function getChatRequest(req,response) {
    ...
    console.log("select room_name,room_id,\"userId\",\"userName\",messageid,description,to_char(timestamp,'MON-DD-YYYY HH12:MIPM') from chat where room_id='"+req+"' order by timestamp desc");
        var query = "select room_name,room_id,\"userId\",\"userName\",messageid,description,to_char(timestamp,'MON-DD-YYYY HH12:MIPM') from chat where room_id='"+req+"' order by timestamp desc";
...
async function getChathistory(req,response) {
    ...
    console.log("select room_id,\"userID\",message,messageid,description,to_char(timestamp,'MON-DD-YYYY HH12:MIPM') from chat_history where room_id='"+req+"' order by timestamp asc");
    var query = "select room_id,\"userID\",message,messageid,description,to_char(timestamp,'MON-DD-YYYY HH12:MIPM') from chat_history where "+"\"room_id\""+"='"+req+"' order by timestamp asc";
...
async function getOnlineUser(req,response) {
    ...
    console.log("select * from (select distinct CONCAT(\"userID\",'_YES' )as \"userid\" ,cn.user from chat_history c join contact cn on c.\"userID\"=cn.\"contactId\" where room_id='"+req+"' union select CONCAT(cn.\"contactId\",'_NO') as \"userid\",cn.user from contact cn join chat_history c on cn.\"contactId\" != c.\"userID\" where room_id='"+req+"' ) as usertable order by usertable asc");
    var query = "select * from (select distinct CONCAT(\"userID\",'_YES' )as \"userid\",cn.user from chat_history c join contact cn on c.\"userID\"=cn.\"contactId\" where room_id='"+req+"' union select CONCAT(cn.\"contactId\",'_NO') as \"userid\",cn.user from contact cn join chat_history c on cn.\"contactId\" != c.\"userID\" where room_id='"+req+"' ) as usertable order by usertable asc";
...
async function getUserChathistory(req,response) {
    ...
    console.log('=========== Start: getChathistory request =========',req);
    console.log("select room_id,\"userID\",message,messageid,description,to_char(timestamp,'MON-DD-YYYY HH12:MIPM') from chat_history where \"userID\"='"+req+"' order by timestamp desc");
    var query = "select room_id,\"userID\",message,messageid,description,to_char(timestamp,'MON-DD-YYYY HH12:MIPM') from chat_history where "+"\"userID\""+"='"+req+"' order by timestamp desc";
