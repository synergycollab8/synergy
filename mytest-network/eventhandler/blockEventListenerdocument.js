...
async function main() {
    try {
        ...
        const contract = await network.getContract(`documentcc`);
        ...
        await contract.addContractListener(async (event) => {
            ...
            console.log("******************************************");
            console.log(event);
            console.log(`${event.doc_hash_code}, ${event.requestId}, ${event.doc_name}, ${event.doc_type}`);
            console.log("******************************************");
            const doc_hash_code =  event.doc_hash_code;
            ...
            if(doc_hash_code){
                ...
                client.query(query, (err, res) => {
                    ...
                    console.log('Data insert successful for document');   
                });
