...
<head>
    <title>Code coverage report for npm-pack-all/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">npm-pack-all</a> index.js</h1>
        <div class='clearfix'>
...
function setBundledDependencies(pj) {
    ...
    pj.bundledDependencies = Object.keys(pj.dependencies || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
    if (cliArgs[`dev-deps`]) {
...
function setArtifactName(args) {
    if (args.output) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (outputDir &amp;&amp; !fs.existsSync(outputDir)) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Feb 10 2021 23:52:26 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
