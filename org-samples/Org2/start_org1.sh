...
peer channel create -c mytestchannel -f ./channel-artifacts/mytestchannel.tx -o centos81:7050 --ordererTLSHostnameOverride $HLF_ORDR_ID --outputBlock ./channel-artifacts/mytestchannel.block --tls --cafile $ORDERER_CA
sleep 30
...
peer channel update -o centos81:7050 --ordererTLSHostnameOverride $HLF_ORDR_ID -c mytestchannel -f ./channel-artifacts/Org1MSPanchors.tx --tls --cafile $ORDERER_CA
